            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="heading">
                        ...
                        <h4 class="h1 heading-title">Dashboard</h4>
                        ...
                        <p class="mb30">De acordo com suas configurações, o sistema está programado para
                        executar a verificação junto à Prefitura todo dia 03 de cada mês, ao final da rotina automatica,
                        será enviado um e-mail para gustavo@contjet.com.br, informando que os arquivos estão disponíveis para download.
