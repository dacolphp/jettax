            ...
            <div class="header-content-wrapper">
                ...
                <nav id="primary-menu" class="primary-menu">
                    ...
                    <ul class="primary-menu-menu">
                        ...
                        <li class="">
                            <a href="03_services.html">Benefícios</a>
                            <ul class="dropdown">
                                <li class="megamenu-item-info">
                                    <h5 class="megamenu-item-info-title">Lista de Benefícios</h5>
                                    <p class="megamenu-item-info-text">Como funciona?</p>
                                </li>
                                <li class="hover-ver2">
						  ...
						  <li class="">
                            <a href="14_blog.html">Contratar</a>
                        </li>
                        <li class="">
                            <a href="14_blog.html">Blog</a>
                        </li>
                        <li class="">
                            <a href="22_contacts.html">Contato</a>
                        </li>
                        <li class="">
                            <button class="btn btn-medium btn--green btn-hover-shadow js-open-aside">
    ...
    <div class="popup right-menu">
        ...
        <div class="right-menu-wrap">
            ...
            <div class="widget login">
                ...
                <h4 class="login-title">Entre com sua conta</h4>
                <input class="email input-standard-grey" placeholder="Usuário ou E-mail" type="text">
                <input class="password input-standard-grey" placeholder="Senha" type="password">
                <div class="login-btn-wrap">

                    <div id="cssLogin" class="btn btn-medium btn--dark btn-hover-shadow">
                        <span class="text">Entrar</span>
                        <span class="semicircle"></span>
                    </div>
                ...
                <div class="helped">Esqueceu a senha?</div>
                <div class="helped">Cadastar-se</div>
        ...
        <div class="widget contacts">
            ...
            <h4 class="contacts-title">Entre em contato</h4>
            <p class="contacts-text">Caso tenha alguma dúvida com relação a usabilidade do sistema, será um prazer para nosso time do suporte te ajudar.
            </p>
			<?php /*
			...
			*/
            ...
            <div class="contacts-item">
                ...
                <div class="content">
                    <a href="#" class="title">suporte@gettax.com.br</a>
            ...
            <div class="contacts-item">
                ...
                <div class="content">
                    <a href="#" class="title">Barra Funda, SP</a>
                    <p class="sub-title">Av. Marquês de São Vicente, 446, Cj. 806</p>
                </div>
            </div>
                                ...
                                <form class="seo-score-form input-inline">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 no-padding col-md-12 col-xs-12 col-sm-12">
                                            <input class="input-dark site" required="required" placeholder="Type in your Website URL">
                                        </div>
...
$(function(){
	...
	$('#cssLogin').click(function(){
		self.location.href = "logado.php"; 					  
	});
});
</script>
